...
import { SeatingTable } from '@/shared/model/seating-table.model';
...
describe('Service Tests', () => {
  describe('SeatingTable Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a SeatingTable', async () => {
      ...
      it('should not create a SeatingTable', async () => {
      ...
      it('should not update a SeatingTable', async () => {
      ...
      it('should not partial update a SeatingTable', async () => {
      ...
      it('should not return a list of SeatingTable', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a SeatingTable', async () => {
      ...
      it('should not delete a SeatingTable', async () => {
